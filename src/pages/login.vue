    ...
    <el-row :gutter="0" class="min-h-screen bg-indigo-500">
        <el-col :md="12" :lg="16" :offset="0" class="flex items-center justify-center">
            <div class="px-10 sm:px-30">
                ...
                <div class="sm:text-sm xl:text-md text-gray-200 font-normal" >此站点是《Vue3实战商城后台管理系统开发》视频课程的演示地址，<el-link type="default" href="https://study.163.com/course/courseMain.htm?courseId=1212775807&share=2&shareId=480000001892585" target="_blank" style="color:white;font-weight:bold;">点击立即学习</el-link>
                 </div>
            </div>
        </el-col>
